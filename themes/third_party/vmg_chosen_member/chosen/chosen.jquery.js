...
// Modified by Luke Wilkins <luke@vectormediagroup.com>.
// Added Ajax support and other options for use with the VMG Chosen Member
// fieldtype for Expression Engine. Some original work from @rong1129's Ajax
// implementation work.
  ...
  */
  ...
  Chosen = (function() {
    function Chosen(elmn, data, options) {
      ...
      this.max_selections = this.is_multiple ? ((options != null) && 'max_selections' in options ? options.max_selections : 0) : 1;
      this.set_up_html();
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      if (this.results_source != null) {
        ...
        this.search_field.keyup(function(evt) {
          if ($.trim(this.value) === '' || evt.keyCode < 48 || evt.keyCode > 90) {
            return true;
          }
          if (this.xhr != null) {
            this.xhr.abort();
    ...
    Chosen.prototype.results_build = function(results) {
      ...
      startTime = new Date();
      this.parsing = true;
      if (this.results_source != null && (results != null)) {
        hash = {};
      ...
      for (_j = 0, _len3 = _ref2.length; _j < _len3; _j++) {
        ...
        if (data.group) {
          ...
          if ((this.results_source != null && (results != null)) || (this.max_selections > 0 && this.max_selections <= this.choices)) {
            continue;
          }
    ...
    Chosen.prototype.choice_append = function(text, value) {
      ...
      if (!this.max_selections || this.max_selections > this.choices) {
        ...
        if (this.max_selections > 1) {
          alert("Maximum number of selections reached.\nLimit: " + this.max_selections);
        }
      }
      this.results_hide();
      this.search_field.val("");
